...
public class CategoryRepository {
    private List<Category> categoryList = new ArrayList<>() {{
        add(new Category(1, "Beverages", "Soft drinks and beverages", true));
        add(new Category(2, "Snacks", "Chips and snack products", true));
        add(new Category(3, "Dairy", "Milk and dairy products", true));
        add(new Category(4, "Frozen Food", "Frozen food products", false));
    }};
